...
namespace POSCHAR.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,Address,PhoneNumber,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,Address,PhoneNumber,Email")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
